...
export default function ResultsPage() {
  ...
  const performance = useMemo(() => {
    const settled = periodTickets.filter((ticket) => ticket.strategyVersion === "history-market-v2" && (ticket.status === "WON" || ticket.status === "LOST"));
