...
export default function ResultsPage() {
  ...
  const performance = useMemo(() => {
    const settled = periodTickets.filter((ticket) => ticket.strategyVersion === "ensemble-calibrated-v3" && (ticket.status === "WON" || ticket.status === "LOST"));
