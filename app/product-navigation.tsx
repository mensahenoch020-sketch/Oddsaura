...
const items: Array<{ id: ProductArea; href: string; label: string; icon: React.ReactNode }> = [
  ...
  { id: "matches", href: "/matches", label: "Football", icon: <><circle cx="12" cy="12" r="8.5" /><path d="m9.5 9 2.5-1.5L14.5 9l-.9 3H10.4zM6.2 14l4.2-2m7.4 2-4.2-2M12 7.5V3.6" /></> },
  { id: "predictions", href: "/dashboard#quick-tickets", label: "Predictions", icon: <><path d="M5 19V9m7 10V5m7 14v-7" /><path d="m3.5 11 3-3 4 2 4-5 5 3" /></> },
