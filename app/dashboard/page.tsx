...
export default function DashboardPage() {
  ...
  return <main className="oa-app">
    <header className="oa-header">
      <Brand href="/dashboard" className="oa-brand" />
      <div className={`oa-status oa-status-${snapshot.status}`}><span /> {refreshing ? "Checking GitHub data…" : statusLabel(snapshot.status)}</div>
      <div className="oa-header-actions"><a className="oa-matches-link" href="/matches">Matches</a><a className="oa-matches-link" href="/results">Results</a><a className="oa-builder-link" href="/builder">Choose predictions</a><a className="oa-admin-link" href="/account">Account</a></div>
    </header>
