...
export function OddsAuraMark({ className = "" }: { className?: string }) {
  return <svg className={className} viewBox="0 0 48 48" role="img" aria-label="OddsAura">
    ...
    <path d="M11 31.5 19.2 24l6 3.4L37 16.8" fill="none" stroke="#19c36a" strokeWidth="6.5" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="37" cy="16.8" r="3.3" fill="#19c36a" />
  </svg>;
}
