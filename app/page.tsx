...
export default function Home() {
  ...
  return <main className="oa-app">
    <header className="oa-header">
      ...
      <div className="oa-header-actions"><a className="oa-matches-link" href="/matches">Matches</a><a className="oa-builder-link" href="/builder">Build a slip</a><a className="oa-admin-link" href="/admin">System</a></div>
    </header>
    ...
    <nav className="oa-filters" aria-label="Ticket categories"><a className="oa-matches-cta" href="/matches">Live & upcoming</a><a className="oa-build-cta" href="/builder">Pick your own matches</a><a href="#safe">Safe 2–3 Odds</a><a href="#balanced">Balanced 5–10 Odds</a><a href="#high-risk">High Risk</a><a href="#markets">All markets</a></nav>
