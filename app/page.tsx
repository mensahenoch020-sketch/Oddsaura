...
export default function LandingPage() {
  return <main className="landing">
    ...
    <section className="landing-hero landing-shell">
      <div className="landing-hero-copy"><span className="landing-kicker">OddsAura Football</span><h1>Football predictions.<br /><i>Booking codes.</i></h1><p>Pick matches, build your slip and generate verified booking codes for supported bookmakers.</p><div className="landing-actions"><Link className="primary" href="/converter">Open code converter</Link><Link className="secondary" href="/signup">Create account</Link><Link className="secondary" href="/login">Log in</Link></div></div>
      <div className="landing-bookmakers" aria-label="Supported bookmakers"><span>Bookmakers</span><div><strong>SportyBet</strong><strong>Bet9ja</strong><strong>betPawa</strong><strong>BetKing</strong><strong>Betway</strong></div></div>
    </section>
    <section className="landing-shortcuts"><div className="landing-shell"><Link href="/converter"><span>01</span><strong>Convert a Code</strong></Link><Link href="/daily"><span>02</span><strong>Daily Odds</strong></Link><Link href="/builder"><span>03</span><strong>Pick Matches</strong></Link><Link href="/results"><span>04</span><strong>Track Results</strong></Link></div></section>
