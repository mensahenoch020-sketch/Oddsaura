...
export default function LandingPage() {
  return <main className="landing">
    ...
    <section className="landing-shortcuts"><div className="landing-shell"><Link href="/signup"><span>01</span><strong>Create Account</strong></Link><Link href="/daily"><span>02</span><strong>Daily Odds</strong></Link><Link href="/builder"><span>03</span><strong>Pick Matches</strong></Link><Link href="/results"><span>04</span><strong>Track Results</strong></Link></div></section>
