...
export default function AuthForm({ mode }: { mode: AuthMode }) {
  ...
  return <form className="auth-form" onSubmit={submit}>
    ...
    {mode === "signup" && <label className="check-label auth-terms"><input name="acceptedTerms" type="checkbox" required /> <span>I am 18 or older and agree to the <Link href="/terms" target="_blank">Terms</Link> and <Link href="/privacy" target="_blank">Privacy Policy</Link>.</span></label>}
