...
export type ExpandedPerformance = { markets?: MarketTest[]; baseline?: { label: string; accuracy: number | null }; limitations?: string[]; builderAudit?: {limitation: string; rows: Array<{target:number;days:number;built:number;noTicket:number;won:number;lost:number}>} };
